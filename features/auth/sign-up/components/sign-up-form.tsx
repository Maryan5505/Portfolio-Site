...
export function SignUpForm() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex justify-center items-start pt-8 bg-white  dark:bg-background">
      <motion.div
        className="w-full max-w-3xl bg-background rounded-2xl bg-linear-to-r from-pink-200 via-purple-200 to-indigo-200 dark:bg-linear-to-r  dark:from-[#101124] dark:via-[#1c1c38] dark:to-[#27274f]   overflow-hidden relative"
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {currentFields.map((key) => {
                  const formField =
                    SignUpFormValues[key as keyof typeof SignUpFormValues];
                  return (
                    <Controller
                      key={key}
                      ...
                      render={({ field, fieldState }) => (
                        <Field className="w-full flex flex-col">
                          ...
                          <Input
                            ...
                            type={formField.type}
                            className="w-full px-4 py-3 rounded-lg border-teal-50 dark:border-gray-600 focus:ring-2 focus:ring-red-400"
